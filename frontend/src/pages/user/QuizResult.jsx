...
export default function QuizResult() {
  ...
  if (!result) return <div className="text-center text-white">{t('result.notFound')}</div>;
    ...
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="glass p-6 rounded-2xl flex items-center gap-4 border border-gray-200 dark:border-white/10">
          ...
          <div>
            <p className="text-sm text-gray-500 dark:text-gray-400">{t('result.timeTaken')}</p>
        ...
        <div className="glass p-6 rounded-2xl flex items-center gap-4 border border-gray-200 dark:border-white/10">
          ...
          <div>
            <p className="text-sm text-gray-500 dark:text-gray-400">{t('result.completedOn')}</p>
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
        ...
        <Link to={`/history/${attemptId}`} className="w-full sm:w-auto">
          <Button variant="secondary" className="w-full justify-center">
            ...
            {t('result.actions.reviewAnswers')}
          </Button>
        </Link>
